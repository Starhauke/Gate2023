...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.5]
        ...
        \node[circle,fill,inner sep=1.5pt,label=above right:{$0$}] at (0,0) {};
        \node[circle,fill,inner sep=1.5pt,label=above right:{$1$}] at (1,0) {};
        \node[circle,fill,inner sep=1.5pt,label=above right:{$-2$}] at (-2,0) {};
    \end{tikzpicture}
    \caption{Region of Convergence (ROC) for $|z| = 3$}
    \label{fig:roc}
\end{figure}
